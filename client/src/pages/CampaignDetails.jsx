...
const CampaignDetails = () => {
  ...
  const handleEndPoll = async (pId) => {
    // Implement vote handling logic here
    try {
      const provider = new ethers.providers.Web3Provider(window.ethereum);
      const signer = provider.getSigner();
      const pollContract = new ethers.Contract(
        "0x7E141fD5308B885533351bf6d817839d61Ed2DB7",
        PollContractAbi,
        signer
      );
      ...
      const tx = await pollContract.endPoll(pId);
      await tx.wait();
      alert(`Poll ended with selected option: ${pId}`);
    } catch (error) {
  ...
  return (
    <div>
      ...
      <div className="w-full flex md:flex-row flex-col mt-10 gap-[30px]">
        ...
        <div className="flex md:w-[150px] w-full flex-wrap justify-between gap-[30px]">
          <CountBox title="Status" value={state.active ? "Active" : "Ended"} />
          <CountBox
          ...
          <div>
            ...
            {/* <div className="mt-[20px]">
              ...
              <CustomButton
                btnType="button"
                title="End Poll"
                styles="mt-[20px] bg-[#8c6dfd]"
                handleClick={() => handleEndPoll(state.pId)}
              />
            </div> */}
            <div className="mt-[20px]">
              <div className="mt-[10px] flex flex-col gap-2">
                {state.options.map((option, index) => (
                  <div
                    key={index}
                    className="font-epilogue font-normal text-[14px] text-[#808191] leading-[24px]"
                  >
                    <p>
                ...
                <button
                  ...
                  onClick={()=>handleEndPoll(state.pId)}
                >
                  End Poll
                </button>
              </div>
...
//           </div>
//           <div>
//             <h4 className="font-epilogue font-semibold text-[18px] text-white uppercase">Poll</h4>
//             <div className="mt-[20px]">
//               <p className="font-epilogue font-normal text-[16px] text-[#808191] leading-[26px] text-justify">{state.title}</p>
//               <div className="mt-[20px] flex flex-col gap-4">
//                 {state.options.map((option, index) => (
//                   <label key={index} className="font-epilogue font-normal text-[16px] text-[#808191] leading-[26px] text-justify">
//                     <input
//                       type="radio"
//                       name="poll"
//                       value={option.option}
...
//           </div>
//         </div>
//         {/* Uncomment if donation functionality is needed */}
//         {/* <div className="flex-1">
//           <h4 className="font-epilogue font-semibold text-[18px] text-white uppercase">Fund</h4>
//           <div className="mt-[20px] flex flex-col p-4 bg-[#1c1c24] rounded-[10px]">
//             <p className="font-epilogue fount-medium text-[20px] leading-[30px] text-center text-[#808191]">
